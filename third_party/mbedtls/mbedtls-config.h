...
//#define MBEDTLS_PLATFORM_STD_CALLOC  goPlatCAlloc /**< Default allocator to use, can be undefined */
//#define MBEDTLS_PLATFORM_STD_FREE      goPlatFree /**< Default free to use, can be undefined */
